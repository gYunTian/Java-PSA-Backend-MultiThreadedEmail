...
/**
 * User New Password Service tasks used for REST APIs to validate
...
public class UserResetPwDTOService {
    ...
    // Response messages
    final String errorMsgPrefix = "Password reset unsuccessful - ";
     ...
     *          else null.
     */
    private ResponseEntity<String> invalidResetPwResponse(User existingUser, String tokenGiven) {
