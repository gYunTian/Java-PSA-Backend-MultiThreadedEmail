 ...
 * 1st, 2nd and 3rd functional requirements for Server Application.
 */
...
public class JobService {
     ...
     *                      in json format.
     * @param apiKey    API key that will be used to fetch data.
     ...
     * @param message String containing the status of the quartz job.
     */
    ...
    /**
     * Private and customized method that maps a JSON array to Java List of Vessel type.
