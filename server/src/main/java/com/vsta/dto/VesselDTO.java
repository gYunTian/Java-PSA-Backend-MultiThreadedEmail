 ...
 * from native query object to a temporary Vessel entity Reference:
...
public interface VesselDTO {
     ...
     * @return This VesselDTO's Berthing date. Date format in ISO8601 -
     *         $YYYY-MM-DDThh:mm.
     */
    String getBthgDt();
     ...
     * @return This VesselDTO's Unberthing date. Date format in ISO8601 -
     *         $YYYY-MM-DDThh:mm.
     */
    String getUnbthgDt();
